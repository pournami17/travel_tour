      ...
      {       
        ...
        echo '<span class="price-holder">';
            if( ( isset( $meta['trip_prev_price'] ) && $meta['trip_prev_price'] ) && ( isset( $meta['sale'] ) && $meta['sale'] ) && ( isset( $meta['trip_price'] ) && $meta['trip_price'] ) )
            {
                ...
                echo '<span class="old-price">' . esc_html( $currency ) .'&nbsp;' .  esc_html( $obj->wp_travel_engine_price_format( $prev_cost ) ) . '</span>';
                echo '<span class="new-price">'. esc_html( $currency ) .'&nbsp;' . esc_html( $obj->wp_travel_engine_price_format( $cost ) ) .'</span>';
            } elseif( isset( $meta['trip_prev_price'] ) && $meta['trip_prev_price'] )
            {
                ...
                echo '<span class="new-price">'. esc_html( $currency ) .'&nbsp;' . esc_html( $obj->wp_travel_engine_price_format( $prev_cost ) ) .'</span>';
            }
        echo '</span>';
      }                                 
    }
