<?php
    ...
    $additional_fields = isset(  $wp_travel_engine_settings['additional_fields'] ) && is_array( $wp_travel_engine_settings['additional_fields'] ) ? $wp_travel_engine_settings['additional_fields'] : array(); 
?>
        ...
        <?php } 
            if ( ! empty( $additional_fields ) ) {
                foreach( $additional_fields as $key => $value ) {
                    ...
                    ?>
                    <label for="wp_travel_engine_booking_setting[place_order][booking][<?php echo esc_attr( $key );?>]"><?php echo esc_html( $data_label ); ?></label>
                    <input type="tel" value="<?php echo isset( $value ) ? esc_attr( $value ):'' ;?>" name="wp_travel_engine_booking_setting[place_order][booking][<?php echo esc_attr( $key );?>]" id="wp_travel_engine_booking_setting[place_order][booking][<?php echo esc_attr( $key );?>]" >
                <?php
                }
            }
