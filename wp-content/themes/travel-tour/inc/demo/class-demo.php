...
if ( ! class_exists( 'Travel_Tour_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Travel_Tour_Demo {

		/**
		 * Singleton instance of Travel_Tour_Demo.
		 *
		 * @var Travel_Tour_Demo $instance Travel_Tour_Demo instance.
		 */
		...
		/**
		 * Main Travel_Tour_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Travel_Tour_Demo ) ) {
				self::$instance = new Travel_Tour_Demo();
